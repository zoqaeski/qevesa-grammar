...
Proto-Teranean is reconstructed to have had twenty-seven consonants, and three
...
% Concurrent with this sound change was a fronting of the
...
\begin{description}
  ...
  \item[N-Stem] This stem is mainly passive in function, and typically reduces
    ...
    was formed by addition of a prefix \Q{n-}.
  \item[S-Stem] This stem increases the valency by one, and typically ascribes
    ...
    daughter languages, indicated by a prefixed \Q{š-}, \Q{s-}, \Q{h-} or
    \Q{l-}, all of which can be traced back to a Proto-Teranean \Q{ṡ-}.  This
  ...
  \item[T-Stem] This stem is mediopassive in origin, and typically indicates a
    reflexive or reciprocal action.  It is formed by the addition of a \Q{-t-}
...
aspect marking.  The three most common suffixes are \Q{-n}, \Q{-ṡ}, and \Q{-k},
...
male entities were the suffixes \Q{-ḱ}, \Q{-r}, and a lengthened final vowel;
female entities were usually unmarked, but the suffixes \Q{-yV}, \Q{-t} and
\Q{-ss} were occasionally used.

\subsubsection{Number}
\label{sssec:history:pt:nm:number}

Proto-Teranean nouns had a three-way distinction between singular, dual, and
plural.  The dual number was always marked by the suffix \Q{-eb}, but the
plural may be formed by the addition of suffixes, internal vowel changes, or in
rare cases, both.  The most common plural suffix was \Q{-ty}.
...
nature, with an \Q{-e-} inserted after a dual or plural suffix.  These suffixes
