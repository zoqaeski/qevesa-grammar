...
\begin{document}
  ...
  forms, or \qevesa{???} (“constructions”), from the root \qevesa{mudat}
...
%  - temussa “tall” ← tumus (grow)
  ...
  marked by the patterns \qevesa{C\sub1{u}C\sub2{a}C\sub3}.
...
% kupuš - to eat                puhut - to say            huku - to go
% kipušain      kipušenín       pihutain   pihutesín      hikuin   hikuetín
...
% kipušisan     kipušenisan     pihutisan  pihutesisan    hikusan  hikuetisan
...
% mištuju - to buy              rukut - to write
% mištijuin     mištijuesín     rikutain   rikuterain      
...
% mištijusan    mištijuesisan   rikutisan  rikuterisan    
...
%  \end{exe}
  ...
  Verbs in Qevesa are negated by using a the negative particle \qevesa{en},
...
%  \newpage
  ...
  invite”) (J2).  The root \qevesa{juta} (“know”) is both weak and soft
  (J1/H3).
