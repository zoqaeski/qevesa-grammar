  ...
  \begin{table}[htpb]\small\capstart
    ...
    \subfloat[Biliteral roots]{
      \begin{tabular}{|>{\bfseries}fc|-c|-c|}
        ...
        \hline
    \end{tabular}}
    \caption{Aorist series transfix patterns\label{tab:vm_perfective_series}}
  \end{table}
  ...
  \begin{table}[htpb]\small\capstart
    ...
    \subfloat[Biliteral roots]{
      \begin{tabular}{|>{\bfseries}fc|-c|-c|-c|}
        ...
        \tnl
        2 & 
        C\sub1{e}C\sub2{i}C\sub2 & 
        C\sub1{e}C\sub2{o}C\sub2 & 
        C\sub1{e}C\sub2{a}C\sub2
        \tnl
        3 & 
...
%  \section{Participles}
%  \label{sec:vm_participles}
%
%  In addition to the nominal participles described in Section~\ref{ssec:dev_active_passive_participles}, there are also adjectival participles derived from the tense-aspect conjugations. 
%
%  \begin{table}[htpb]\small\capstart
%      \subfloat[Triliteral roots]{
%        \begin{tabular}{|>{\bfseries}fc|-c|-c|-c|-c|-c|}
%          \hline
%          \SetRowStyle{\bfseries} Form & \multicolumn{3}{-c|}{Imperfective} & \multicolumn{2}{-c|}{Perfective} \tnl
%          \cline{2-6}
%          \SetRowStyle{\bfseries} & Present & Past & Future & Past & Future \tnl
%          \cline{2-6}
%          \SetRowStyle{\scshape} & \acs{prs} & \acs{ipf} & \acs{fut};\acs{ipfv} & \acs{aor} & \acs{fut};\acs{pfv} \tnl
%          \hline
%          1 & 
%          C\sub1{o}C\sub2{i}C\sub3 & 
%          C\sub1{o}C\sub2{u}C\sub3 & 
%          C\sub1{o}C\sub2{a}C\sub3 &
%          C\sub1{io}C\sub2{u}C\sub3 & 
%          C\sub1{io}C\sub2{a}C\sub3
%          \tnl
%          2 & 
%          C\sub1{o}C\sub2C\sub2{i}C\sub3 & 
%          C\sub1{o}C\sub2C\sub2{u}C\sub3 & 
%          C\sub1{o}C\sub2C\sub2{a}C\sub3 &
%          C\sub1{io}C\sub2C\sub2{u}C\sub3 & 
%          C\sub1{io}C\sub2C\sub2{a}C\sub3
%          \tnl
%          3 & 
%          C\sub1{o}C\sub2C\sub3{i} & 
%          C\sub1{o}C\sub2C\sub3{u} & 
%          C\sub1{o}C\sub2C\sub3{a} &
%          C\sub1{io}C\sub2C\sub3{u} & 
%          C\sub1{io}C\sub2C\sub3{a}
%          \tnl
%          4 & 
%          {i}C\sub1C\sub2{o}C\sub3{i} & 
%          {i}C\sub1C\sub2{o}C\sub3{u} & 
%          {i}C\sub1C\sub2{o}C\sub3{a} &
%          {i}C\sub1C\sub2{io}C\sub3{u} & 
%          {i}C\sub1C\sub2{io}C\sub3{a}
%          \tnl
%          5 & 
%          {me}C\sub1{o}C\sub2{i}C\sub3 & 
%          {me}C\sub1{o}C\sub2{u}C\sub3 & 
%          {me}C\sub1{o}C\sub2{a}C\sub3   &
%          {me}C\sub1{io}C\sub2{u}C\sub3 & 
%          {me}C\sub1{io}C\sub2{a}C\sub3  
%          \tnl
%          6 & 
%          {ta}C\sub1C\sub2{o}C\sub3{i} & 
%          {ta}C\sub1C\sub2{o}C\sub3{u} & 
%          {ta}C\sub1C\sub2{o}C\sub3{a} &
%          {ta}C\sub1C\sub2{io}C\sub3{u} & 
%          {ta}C\sub1C\sub2{io}C\sub3{a}
%          \tnl
%          7 & 
%          C\sub1{ë}C\sub2{o}C\sub3{i} & 
%          C\sub1{ë}C\sub2{o}C\sub3{u} & 
%          C\sub1{ë}C\sub2{o}C\sub3{a} &
%          C\sub1{ë}C\sub2{io}C\sub3{u} & 
%          C\sub1{ë}C\sub2{io}C\sub3{a}
%          \tnl
%          \hline
%        \end{tabular}
%      }\\
...
%          \tnl
%          2 & 
%          C\sub1{o}C\sub2{i}C\sub2 & 
%          C\sub1{o}C\sub2{u}C\sub2 & 
%          C\sub1{o}C\sub2{a}C\sub2 &
%          C\sub1{io}C\sub2{u}C\sub2 & 
%          C\sub1{io}C\sub2{a}C\sub2
%          \tnl
%          3 & 
%          C\sub1{o}C\sub2C\sub2{i} & 
%          C\sub1{o}C\sub2C\sub2{u} & 
%          C\sub1{o}C\sub2C\sub2{a} &
%          C\sub1{io}C\sub2C\sub2{u} & 
%          C\sub1{io}C\sub2C\sub2{a}
%          \tnl
%          4 & 
%          {i}C\sub1C\sub1{o}C\sub2{i} & 
%          {i}C\sub1C\sub1{o}C\sub2{u} & 
%          {i}C\sub1C\sub1{o}C\sub2{a} &
%          {i}C\sub1C\sub1{io}C\sub2{u} & 
%          {i}C\sub1C\sub1{io}C\sub2{a}
%          \tnl
%          5 & 
%          {me}C\sub1{o}C\sub2{i} & 
%          {me}C\sub1{o}C\sub2{u} & 
%          {me}C\sub1{o}C\sub2{a}   &
%          {me}C\sub1{io}C\sub2{u} & 
%          {me}C\sub1{io}C\sub2{a}  
%          \tnl
%          6 & 
%          {ta}C\sub1{o}C\sub2C\sub2{i} & 
%          {ta}C\sub1{o}C\sub2C\sub2{u} & 
%          {ta}C\sub1{o}C\sub2C\sub2{a} &
%          {ta}C\sub1{io}C\sub2C\sub2{u} & 
...
%          {ë}C\sub1{o}C\sub2{u} & 
%          {ë}C\sub1{o}C\sub2{a} &
%          {ë}C\sub1{io}C\sub2{u} & 
%          {ë}C\sub1{io}C\sub2{a}
%          \tnl
%          \hline
%        \end{tabular}}
%      \caption{Adjectival participle transfix patterns\label{tab:vm_adjectival_participles}}
%  \end{table}
