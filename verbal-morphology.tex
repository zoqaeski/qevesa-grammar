...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c -c}
      \toprule
      & & \Q{kérru} “request” & & \Q{mácchu} “heat, make hot” \\
      \SetRowStyle{\bfseries} Aspect & & Stem & & Stem \\
      \midrule
      Perfective   & \acs{perf} & kérru   &  & mácchu  \\
      Experiential & \acs{exp}  & kérra   &  & máccha  \\
      Momentane    & \acs{momt} & kérri   &  & mácchi  \\
      Progressive  & \acs{prog} & jakúrre &  & jamúccha \\
      Durative     & \acs{dur}  & jakárre &  & jamáccha \\
      Habitual     & \acs{hab}  & jakírre &  & jamíccha \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & mucchéne & emacchí & šemacchý \\
...
\begin{itemize}
  ...
  \item Forming so-called autoreflexive verbs that denote (often involuntary)
    actions performed on one’s body: \Q{náchoru} “sneeze”
