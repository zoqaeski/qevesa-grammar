...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspect stems]{%
    \begin{tabular}{BFl Sl -cw -c}
      ...
      Progressive  & \acs{prog} & amúra & ašúle \\
      Durative     & \acs{dur}  & amára & ašále \\
      Habitual     & \acs{hab}  & amíra & ašíle \\
      \bottomrule
    \end{tabular}
  }\\
...
The imperfective aspects prefix \Q{a-} and switch the final two vowels; that
is, they take the form *\Q{aC₁C₂VːC₂y}, where V is one of \Q{-ú-}
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -cw -c}
      \toprule
      & & \Q{vyss} “flow” & \Q{tymm} “finish” \\
      \SetRowStyle{\bfseries} Aspect & & Stem & Stem \\
      \midrule
      Perfective   & \acs{perf} & vyssu  & tymmu  \\
      Experiential & \acs{exp}  & vyssa  & tymma  \\
      Momentane    & \acs{momt} & vyssi  & tymmi  \\
      Progressive  & \acs{prog} & avsúsy & atmúmy \\
      Durative     & \acs{dur}  & avsásy & atmámy \\
      Habitual     & \acs{hab}  & avsísy & atmímy \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{table}[h!]\small\capstart
  \centering
  \subfloat[Aspect stems]{%
    \begin{tabular}{BFl Sl -c -cw -c -cw -c -c}
      \toprule
      & & \multicolumn{2}{c}{\Q{hevur} “be good”} & \multicolumn{2}{c}{\Q{pohut} “speak”} & \multicolumn{2}{c}{\Q{žorú} “tie, bind”} \\
      ...
      Progressive  & \acs{prog} & ávur  & ávure & apphút & apphúte & ažrú & ažrúhe \\
      Durative     & \acs{dur}  & ávar  & ávare & apphát & appháte & ažrá & ažráhe \\
      Habitual     & \acs{hab}  & ávir  & ávire & apphít & apphíte & ažrí & ažríhe \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspect stems]{%
    \begin{tabular}{BFl Sl -c -cw -c -cw -c -c}
      \toprule
      & & \multicolumn{2}{c}{\Q{jotú} “know”} & \multicolumn{2}{c}{\Q{kojur} “read”} & \multicolumn{2}{c}{\Q{voluj} “rise (sun, moon)”} \\
      \SetRowStyle{\bfseries} Aspect & & Indicative & Modal & Indicative & Modal & Indicative & Modal \\
      \midrule
      ...
      Progressive  & \acs{prog} & ažtú & ažtúhe & akjúr & akjúre & avlúj & avlúje \\
      Durative     & \acs{dur}  & ažtá & ažtáhe & akjár & akjáre & avláj & avláje \\
      Habitual     & \acs{hab}  & ažtí & ažtíhe & akír  & akíre  & avlí  & avlíje \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
with \Q{-a-} or \Q{-i-}.  The modal stem appends a \Q{-e} to the indicative
stem. 

The imperfective aspects use the pattern *\Q{aC₁C₁V₂ːC₂C₃V₁}, where V₁ is the
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -cw -c -c}
      ...
      Progressive  & \acs{prog} & assúpto & assúpte & allúcme & allúcme \\
      Durative     & \acs{dur}  & assápto & assápte & allácme & allácme \\
      Habitual     & \acs{hab}  & assípto & assípte & allícme & allícme \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
The imperfective aspects prefix \Q{a-} and switch the final two vowels; that
is, they take the form *\Q{aC₁V₂ːC₂C₂V₁}, where V₁ is the short inherent vowel
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -cw -c}
      ...
      Progressive  & \acs{prog} & akúrre & amúšša \\
      Durative     & \acs{dur}  & akárre & amášša \\
      Habitual     & \acs{hab}  & akírre & amíšša \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
The modal stem appends a \Q{-e} to the indicative stem. 

The imperfective aspects use the pattern *\Q{aC₁eC₂C₃VːC₄y}, where V is
\Q{-ú-}, \Q{-á-} or \Q{-í-} for the progressive, durative and habitual aspects.
The modal stems replace the final \Q{-y} with \Q{-e}.  
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      ...
      Progressive  & \acs{prog} & azenzúny & azenzúne  \\
      Durative     & \acs{dur}  & azenzány & azenzáne  \\
      Habitual     & \acs{hab}  & azenzíny & azenzíne  \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      \toprule
      & & \multicolumn{2}{c}{\Q{vyssus} “flood”} \\
      ...
      Progressive  & \acs{prog} & avsússy & avsússe \\
      Durative     & \acs{dur}  & avsássy & avsásse \\
      Habitual     & \acs{hab}  & avsíssy & avsísse \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspect stems]{%
    \begin{tabular}{BFl Sl -c -cw -c -cw -c -c}
      ...
      Progressive  & \acs{prog} & aižúnro & aižúnre & avvúljo & avvúlje & ažžúrro & ažžúrre \\
      Durative     & \acs{dur}  & aižánro & aižánre & avváljo & avválje & ažžárro & ažžárre \\
      Habitual     & \acs{hab}  & aižínro & aižínre & avvíljo & avvílje & ažžírro & ažžírre \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -cw -c -c}
      ...
      Progressive  & \acs{prog} & asaksúpo & asaksúpe & asadsúto & asadsúte \\
      Durative     & \acs{dur}  & asaksápo & asaksápe & asadsáto & asadsáte \\
      Habitual     & \acs{hab}  & asaksípo & asaksípe & asadsíto & asadsíte \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c}
      ...
      Progressive  & \acs{prog} & astúke  \\
      Durative     & \acs{dur}  & astáke  \\
      Habitual     & \acs{hab}  & astíke  \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
The imperfective aspects use the pattern *\Q{asaC₁V₂ːC₂C₂V₂} in the
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      ...
      Progressive  & \acs{prog} & asavússy & asavússe \\
      Durative     & \acs{dur}  & asavássy & asavásse \\
      Habitual     & \acs{hab}  & asavíssy & asavísse \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -cw -c}
      ...
      Progressive  & \acs{prog} & anmúra & antúve \\
      Durative     & \acs{dur}  & anmára & antáve \\
      Habitual     & \acs{hab}  & anmíra & antíve \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{itemize}
  \item \Q{pohut} “speak” → \Q{patótu} “converse (with)”
  \item \Q{rokut} “write” → \Q{ratoktu} “correspond (with)”
  \item \Q{šopur} “buy” → \Q{šatopru} “buy (from)”
  \item \Q{téku} “go” → \Q{tatéku} “go together, go with” (accompaniment)
  \item \Q{kéru} “ask” → \Q{katéru} “ask for (sth)” (intransitive → transitive)
\end{itemize}
...
The imperfective aspects are formed with the pattern *\Q{aC₁atV₂ːC₂C₃a}, where
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -cw -c -c}
      ...
      Progressive  & \acs{prog} & aratúkta & aratúkte & ašatúpra & ašatúpre  \\
      Durative     & \acs{dur}  & aratákta & aratákte & ašatápra & ašatápre  \\
      Habitual     & \acs{hab}  & aratíkta & aratíkte & ašatípra & ašatípre  \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -cw -c}
      ...
      Progressive  & \acs{prog} & atatúke & akatúre \\
      Durative     & \acs{dur}  & atatáke & akatáre \\
      Habitual     & \acs{hab}  & atatíke & akatíre \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
It is marked by the infix \Q{-st-} in all forms, leading to its referral as the \emph{ST-stem}. 
...
The imperfective aspects are formed with the pattern *\Q{astV₁C₁V₂ːC₂C₃a},
where V₁ is the inherent root vowel and V₂ is \Q{-ú-} for the progressive
aspect, \Q{-á-} for the durative aspect, and \Q{-í-} for the habitual aspect.
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      ...
      Progressive  & \acs{prog} & astodústa & astodúste \\
      Durative     & \acs{dur}  & astodásta & astodáste \\
      Habitual     & \acs{hab}  & astodísta & astodíste \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      ...
      Progressive  & \acs{prog} & astúmar & astúmare  \\
      Durative     & \acs{dur}  & astámar & astámare  \\
      Habitual     & \acs{hab}  & astímar & astímare  \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      \toprule
      & & \multicolumn{2}{c}{\Q{istyvsus} “(begin to) flow”} \\
      \SetRowStyle{\bfseries} Aspect & & Indicative & Modal \\
      \midrule
      Perfective   & \acs{perf} & istyvsus & istyvsuse  \\
      Experiential & \acs{exp}  & istyvsas & istyvsase  \\
      Momentane    & \acs{momt} & istyvsis & istyvsise  \\
      Progressive  & \acs{prog} & astúvyss & astúvsyse  \\
      Durative     & \acs{dur}  & astávyss & astávysse  \\
      Habitual     & \acs{hab}  & astívyss & astívysse  \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
The imperfective aspects are formed with the pattern *\Q{antV₁C₁V₂C₂C₃a},
...
%     \begin{tabular}{BFl Sl -cw -c}
%       \toprule
%       & & \Q{iprešu} “be red” & \Q{iksetu} “be ready” \\
%       \SetRowStyle{\bfseries} Aspect & & Stem & Stem \\
%       \midrule
...
\begin{exe}
  ...
  \ex \Q{Kovelnapalli a póriš tumáran.}
...
\begin{exe}
  \ex\label{ex:vm_putting_on_clothes} \Q{Veráninaš havrúnin.}
...
\begin{exe}
  \ex\label{ex:vm_wearing_clothes} \Q{Veráninaš havránin.}
...
are inserted before or after a consonant.  The third person prefix \Q{j-} only
...
%     \toprule
%     \multicolumn{3}{Fc}{\SetRowStyle{\bfseries}‘there’ (away from speaker)} & \multicolumn{3}{-c}{‘here’ (towards speaker)} \\
%     \midrule
