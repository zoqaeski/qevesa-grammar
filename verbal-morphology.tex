...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c -c -c -c}
      ...
      \midrule
      Perfective   & \acs{perf} & sovvut   & sovvute  &  & leccum   & leccume \\
      Experiential & \acs{exp}  & sovvat   & sovvate  &  & leccam   & leccame \\
      Momentane    & \acs{momt} & sovvit   & sovvite  &  & leccim   & leccime \\
  ...
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & suvvete & esávvit   & šesivvýt \\
...
The imperfective aspects are formed with the pattern *\Q{jyC₁V₂ːC₂C₃a}, where
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      ...
      Progressive  & \acs{prog} & jykústa & jykúste \\
      Durative     & \acs{dur}  & jykásta & jykáste \\
      Habitual     & \acs{hab}  & jykísta & jykíste \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
The imperfective aspects are formed with the pattern *\Q{jyC₁V₂ːC₂V₁}, where V₁
...
%       Progressive  & \acs{prog} & jypúrša & jypúrše & jykústa & jykúste \\
%       Durative     & \acs{dur}  & jypárša & jypárše & jykásta & jykáste \\
%       Habitual     & \acs{hab}  & jypírša & jypírše & jykísta & jykíste \\
%       \bottomrule
%     \end{tabular}
%   }\\
%   \subfloat[Non-finite stems]{%
...
The imperfective aspects are formed with the pattern *\Q{jyC₁V₂ːC₂C₂i}, where
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c }
      ...
      Progressive  & \acs{prog} & jyzúlli & jyzúlle \\
      Durative     & \acs{dur}  & jyzálli & jyzálle \\
      Habitual     & \acs{hab}  & jyzílli & jyzílle \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c }
      ...
      Progressive  & \acs{prog} & jyhúvra & jyhúvre \\
      Durative     & \acs{dur}  & jyhávra & jyhávre \\
      Habitual     & \acs{hab}  & jyhívra & jyhívre \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
