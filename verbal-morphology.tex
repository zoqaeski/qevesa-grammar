...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspect stems]{%
    \begin{tabular}{BFl Sl -c -c -c -c -c -c -c -c}
      ...
      Progressive  & \acs{prog} & jávur & jávure &  & japphút & japphúte &  & jažžú & jažžúhe \\
      Durative     & \acs{dur}  & jávar & jávare &  & japphát & jappháte &  & jažžá & jažžáhe \\
      Habitual     & \acs{hab}  & jávir & jávire &  & japphít & japphíte &  & jažží & jažžíhe \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
  \begin{tabular}{BFl -c -c -c}
    ...
    \midrule
    Stem \SetRowStyle{\itshape} & žuré  & ežárí    & šežžú \\
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      ...
      \SetRowStyle{\bfseries} Aspect & & Indicative & Modal \\
      \midrule
      Perfective   & \acs{perf} & istavsus  & istavsuse  \\
      Experiential & \acs{exp}  & istavsas  & istavsase  \\
      Momentane    & \acs{momt} & istavsis  & istavsise  \\
      Progressive  & \acs{prog} & jastúvsas & jastúvsase  \\
      Durative     & \acs{dur}  & jastávsas & jastávsase  \\
      Habitual     & \acs{hab}  & jastívsas & jastívsase  \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
...
participle with the pattern *\Q{šiC₁uC₂C₂}.  
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c}
      ...
      \SetRowStyle{\bfseries}     & Infinitive & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & izelle & šizull \\
      Meaning                     & green  & green \\
      \bottomrule
    \end{tabular}
  }
