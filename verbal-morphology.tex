...
roots with a stative meaning. The citation form of these roots is \conlang{*C₁VC₂uC₃}.
...
root.  The citation form of quadriliteral roots is \conlang{*C₁aC₂C₃eC₄}.
...
their inherent vowel.  The citation form of geminate roots is \conlang{*C₁eC₂C₂}.
...
(\conlang{memódits}\footnotemark). These patterns are sets of verbal conjugations
...
changes.  For example, roots that contain the sequence \conlang{t-l} consistently
replace the cluster \conlang{tl} with \conlang{č} or \conlang{čč}.
...
a stem of the form \conlang{*C₁VC₂uC₃}.  The experiential aspect uses the pattern
\conlang{*C₁VC₂iC₃}.

The subjunctive stems take the form \conlang{*C₁V₁C₂C₃V₂}, where V₁ and V₂ are the first and
second vowels of the indicative stems. 

The imperfective aspects (progressive and durative) use the stem
\conlang{aC₁C₂V₂ːC₃V₁}, where ‘V₁’ is the inherent root vowel and ‘V₂’ is \conlang{-ú-} for the progressive aspect,
\conlang{-í-} for the durative.  
...
always formed by switching the last two vowels, and prefixing with \conlang{a-}. 
...
\begin{table}[h!]\small\capstart
    \begin{tabular}{BFl Kl -c -cw -c -c}
      \toprule
      & & {\conlangt{rokut}{write}} & \multicolumn{2}{c}{\conlangt{vesuk}{lay down}} \\
      ...
      % Momentane  & {\Momt} & rokit  & rokti  & vesik  & veski \\
      \midrule
      Progressive  & {\Prog} & arkuto & ??     & avsuke & ?? \\
      Durative     & {\Dur}  & arkito & ??     & avsike & ?? \\
      % Habitual   & {\Hab}  & arkíto & arkíte & avsíke & avsíke \\
      % \midrule
      \bottomrule
    \end{tabular}
...
The infinitive is formed with the pattern \conlang{C₁uC₂eC₃e}; the active participle
with the pattern \conlang{eC₁áC₂iC₃}; and the passive participle with the pattern
\conlang{neC₁C₂éC₃y}.  
...
is, they take the form \conlang{*aC₁V₂ːC₂V₁}, where V₁ is the short inherent vowel
and V₂ one of \conlang{-ú-} (progressive), \conlang{-á-} (durative), or \conlang{-í} (habitual).
Biliteral roots whose inherent vowel is \conlang{*í} or \conlang{*ú} have \conlang{y} as V₁, and
biliteral roots whose inherent vowel is \conlang{*á} have \conlang{e} as V₁.
...
The imperfective aspects prefix \conlang{a-} and switch the final two vowels; that
is, they take the form \conlang{*aC₁C₂VːC₂e}, where V is one of \conlang{-ú-}
(progressive), \conlang{-á-} (durative), or \conlang{-í} (habitual).
...
same patterns as triliteral roots:  \conlang{*C₁uC₂eC₂e} (infinitive), \conlang{*eC₁áC₂iC₂}
(active participle) and \conlang{*šeC₁C₂éC₂y} (passive participle). 
...
% root; certain consonant clusters (notably \conlang{-tl-}) assimilated resulting in a
...
% include \conlangt{hevvur}{best} (from \conlangt{hevur}{good}) and \conlangt{hellus}{tallest} (from
% \conlangt{velus}{tall}).  
...
The perfective indicative uses a stem of the form \conlang{*C₁VC₂VC₂uC₃}, where ‘V’ is
the inherent vowel.  The experiential and momentane aspects replace the \conlang{-u-}
with \conlang{-a-} or \conlang{-i-}.  

The imperfective aspects use the pattern \conlang{*aC₁V₁C₁C₂V₂ːC₃V₁}, where V₁ is the
inherent vowel and V₂ is \conlang{-ú-}, \conlang{-á-} or \conlang{-í-} for the progressive,
...
\conlang{*C₁uC₁eC₂C₃e}; the active participle with the pattern \conlang{*eC₁áC₁C₂iC₃}; and
the passive participle with the pattern \conlang{*šeC₁C₁éC₂C₃y}.
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabulary}{0.75\textwidth}{BFl Kl -C -Cw -C -C}
      \toprule
                                     & & \conlangt{sosoput}{remind, exhort} & \conlangt{leletum}{shrink, reduce, make small} \\
      \rowstyle{\bfseries} Aspect & & Stem & Stem \\
      \midrule
      Perfective          & {\Perf} & sopoput   & letetum \\
      Experiential        & {\Exp}  & sopopat   & letetam \\
      Momentane           & {\Momt} & sopopit   & letetim \\
      Progressive         & {\Prog} & asoppúto  & alettúme \\
      Durative            & {\Dur}  & asoppáto  & alettáme \\
      Habitual            & {\Hab}  & asoppíto  & alettíme \\
      \bottomrule
    \end{tabulary}
  }\\
  \subfloat[Non-finite stems]{%
...
The perfective indicative is formed by the pattern \conlang{*C₁VːC₁aC₂u}, and the
experiential and momentane aspects replace the final \conlang{-u} with \conlang{-a} or
\conlang{-i}.

The imperfective aspects prefix \conlang{a-} and switch the final two vowels; that
is, they take the form \conlang{*aC₁aC₁V₂ːC₂V₁}, where V₁ is the short inherent vowel
and V₂ one of \conlang{-ú-} (progressive), \conlang{-á-} (durative), or \conlang{-í} (habitual).

The infinitive is marked by the pattern \conlang{*C₁uC₁VːC₂e}, the active participle
by the pattern \conlang{*eC₁áC₁C₂í}, and the passive participle by the pattern
\conlang{*šeC₁C₁éC₂y}.  

\cref{tab:vm:ii_biliteral_stems} lists some example biliteral conjugations. 
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabulary}{0.75\textwidth}{BFl Kl -Cw -Cw -C}
      \toprule
      & & \conlangt{kékaru}{request} & \conlangt{mómašu}{heat, make hot} & \conlangt{cícavu}{freeze, make cold} \\
      \rowstyle{\bfseries} Aspect & & Stem & Stem & Stem \\
      \midrule
      Perfective   & {\Perf} & kékaru  & mómašu  & cícavu  \\
      Experiential & {\Exp}  & kékara  & mómaša  & cícava  \\
      Momentane    & {\Momt} & kékari  & mómaši  & cícavi  \\
      Progressive  & {\Prog} & akakúre & amamúšo & acacúvy \\
      Durative     & {\Dur}  & akakáre & amamášo & acacávy \\
      Habitual     & {\Hab}  & akakíre & amamíšo & acacívy \\
      \bottomrule
    \end{tabulary}
  }\\
  \subfloat[Non-finite stems]{%
...
\label{ssec:vm:ii_quadriliteral}
...
\conlang{*C₁eC₁aC₂C₂u}, and the experiential and momentane aspects replace the final
\conlang{-u} with \conlang{-a} or \conlang{-i}.

The imperfective aspects are formed with the pattern \conlang{*aC₁C₁aC₂V₂ːC₂V₁},
where V₁ is the short inherent vowel and V₂ one of \conlang{-ú-} (progressive),
\conlang{-á-} (durative), or \conlang{-í} (habitual).

The infinitive is marked by the pattern \conlang{*C₁uC₁iC₂C₂e}, the active participle
by the pattern \conlang{*eC₁áC₁aC₂C₂í}, and the passive participle by the pattern
\conlang{*šeC₁aC₁éC₂C₂y}.  

% \Cref{tab:vm:ii_geminate_stems} gives an example conjugated geminate stem in
% Pattern II.
...
%       \midrule
%       Perfective   & {\Perf} & 1e1a22u  \\
%       Experiential & {\Exp}  & 1e1a22a  \\
%       Momentane    & {\Momt} & 1e1a22i  \\
%       Progressive  & {\Prog} & a11a2ú2e \\
%       Durative     & {\Dur}  & a11a2á2e \\
%       Habitual     & {\Hab}  & a11a2í2e \\
%       \bottomrule
%     \end{tabular}
%   }\\
%   \subfloat[Non-finite stems]{%
...
%       \toprule
%                                      & & {\conlangt{jonanvu}{plunder}} & {\conlangt{volalju}{soar}} & {\conlangt{zozokku}{fasten}} \\
%       \rowstyle{\bfseries} Aspect & & Stem                    & Stem                 & Stem \\
%       \midrule
%       Perfective          & {\Perf} & jononvu                 & vololju              & zozokkhú  \\
%       Experiential        & {\Exp}  & jononva                 & vololja              & zozokkhá  \\
%       Momentane           & {\Momt} & jononvi                 & vololí               & zozokkhí  \\
%       Progressive         & {\Prog} & ažnonúvo                & avlolújo             & azozkúho \\
%       Durative            & {\Dur}  & ažnonávo                & avlolájo             & azozkáho \\
%       Habitual            & {\Hab}  & ažnonívo                & avlolíjo             & azozkího \\
%       \bottomrule
%     \end{tabular}
%   }\\
%   \subfloat[Non-finite stems]{%
...
The basic form of Pattern III verbs is prefixing \conlang{sa-} onto the root
...
experiential and momentane aspects replace the final \conlang{-u} with \conlang{-a} or
\conlang{-i}.  Pattern III verbs lack distinct modal stems in the perfective aspects.  
...
The basic form of Pattern IV roots is by prefixing \conlang{na-} onto the root, and as
...
Examples of triliteral stems in Pattern IV are given in \cref{tab:vm:iv_triliteral_stems}. 
...
% \cref{tab:vm:iii_geminate_stems} lists the Pattern IV stems for
...
The general form of Pattern V verbs is inserting the infix \conlang{-at-} immediately
...
Examples of triliteral stems in Pattern VI are given in \cref{tab:vm:v_triliteral_stems}. 
...
\begin{table}[h!]\small\capstart
  ...
  \caption{Pattern VI triliteral stems \label{tab:vm:vi_triliteral_stems}}
\end{table}
...
Examples of biliteral stems are given in \cref{tab:vm:vi_biliteral_stems}. 
...
\begin{table}[h!]\small\capstart
  ...
  \caption{Pattern VI biliteral stems \label{tab:vm:vi_biliteral_stems}}
\end{table}
...
\begin{table}[h!]\small\capstart
  ...
  \caption{Pattern V triliteral stems \label{tab:vm:vii_triliteral_stems}}
\end{table}
...
\subsection{Quadriliteral Roots}
\label{ssec:vm:vii_quadriliteral_roots}
...
% The Qevesa verb is marked for agreement with the subj a combination of prefixed pronomial markers and suffixed
...
\conlang{*-y}, which later induced palatalisation and affrication of preceding
consonants, levelled by analogy due to the root-based morphology.  Likewise,
the dual suffix originated as a \conlang{*-w}, which became \conlang{-v} when
syllable-initial, except before \conlang{*-o}, where it became a diphthong
\conlang{*-uo} and later monophthongised into a long vowel \conlang{-ů}.
...
\begin{table}[h!]\small\capstart
  \begin{tabular}{KFl -c -c -c}
    ...
    \midrule
    {\Fsg}              & ha-          & h-    & \multirow{4}{*}{-s, -z, -š, -ž, -j}\\
    {\Ssg}              & tu-          & t-    & \\
    {\Tsg}              & ∅-           & j-    & \\
    \Inan;\Sg           & ra-          & r-    & \\
    \midrule
    {\Fdu};{\Incl}      & vi-          & v-    & \multirow{5}{*}{-ů, -v} \\
    {\Fpl};{\Excl}      & zi-          & z-    & \\
    {\Sdu}              & ti-          & t-    & \\
    {\Tdu}              & ∅-           & j-    & \\
    \Inan;\Du           & re-          & r-    & \\
    \midrule
    {\Fpl};{\Incl}      & se-          & s-    & \multirow{5}{*}{-t} \\
    {\Fpl};{\Excl}      & ze-          & z-    & \\
    {\Spl}              & ke-          & k-    & \\
    {\Tpl}              & ∅-           & j-    & \\
    \Inan;\Pl           & re-          & r-    & \\
...
\begin{table}[h!]\small\capstart
  \begin{tabular}{KFl -c -c@{ → } -c}
    \toprule
    \rowstyle{\bfseries} & \multicolumn{2}{-c}{Proto-Teranean} & Modern Qevesa \\
    \midrule
    & \multicolumn{3}{c}{\conlangt{rokut}{write}} \\
    \midrule
    ...
    \midrule
    & \multicolumn{3}{c}{\conlangt{vesuk}{lay down}} \\
    \midrule
