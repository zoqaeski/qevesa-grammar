  ...
  \begin{table}[htpb]\small\capstart
      \subfloat[Triliteral roots]{
        \begin{tabular}{|>{\bfseries}fc|-c|-c|-c|-c|-c|}
          ...
          \cline{2-6}
          \SetRowStyle{\scshape} & \acs{ipfv} & \acs{stat} & \acs{dur};\acs{ipfv} & \acs{freq} & \acs{hab} \tabularnewline
          \hline
          I & 
  ...
  \begin{table}[htpb]\small\capstart
      \subfloat[Triliteral roots]{
        \begin{tabular}{|>{\bfseries}fc|-c|-c|-c|-c|-c|}
          ...
          \cline{2-6}
          \SetRowStyle{\scshape} & \acs{pfv} & \acs{inch} & \acs{cess} & \acs{dur};\acs{pfv} & \acs{momt} \tabularnewline
          \hline
          I & 
