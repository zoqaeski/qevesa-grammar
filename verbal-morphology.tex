...
their inherent vowel.  The citation form of geminate roots is \Q{C₁aC₂C₂}.
...
*\Q{C₁aC₂aC₃}, and the momentane aspect uses the pattern *\Q{C₁aC₂iC₃}.  The
...
\Q{aC₁C₂VːC₃}, where ‘V’ is \Q{-ú-} for the progressive aspect,
...
(active participle) and *\Q{šeC₁C₂úC₂} (passive participle). 
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c -c}
      ...
      \SetRowStyle{\bfseries} Aspect & & Stem & & Stem \\
      \midrule
      Perfective   & \acs{perf} & vassu   &  & tammu  \\
      Experiential & \acs{exp}  & vassa   &  & tamma  \\
      Momentane    & \acs{momt} & vassi   &  & tammi  \\
      Progressive  & \acs{prog} & javsúsa &  & jatmúma \\
      Durative     & \acs{dur}  & javsása &  & jatmáma \\
      Habitual     & \acs{hab}  & javsísa &  & jatmíma \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & vusese & evásis  & ševsús \\
...
\begin{table}[h!]\small\capstart
  ...
  \begin{tabular}{BFl -c -c -c}
    ...
    \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
    \midrule
    Stem \SetRowStyle{\itshape} & humese & ehámis   & šémus \\
    Meaning                     & send  & sending  & sent \\
    \midrule
    Stem \SetRowStyle{\itshape} & puhete & epáhit   & šepphút \\
    Meaning                     & speak & speaking & spoken \\
    \midrule
    Stem \SetRowStyle{\itshape} & žuré  & ežárí    & šežrú \\
...
\begin{table}[h!]\small\capstart
  ...
  \begin{tabular}{BFl -c -c -c}
    ...
    \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
    \midrule
    Stem \SetRowStyle{\itshape} & juté  & ejátí   & šežtú \\
    Meaning                     & know  & knowing & known \\
    \midrule
    Stem \SetRowStyle{\itshape} & kujere & ekájir  & šekjúr \\
    Meaning                     & read  & reading & read \\
    \midrule
    Stem \SetRowStyle{\itshape} & vuleje & eválí   & ševlúj \\
...
with \Q{-u-} or \Q{-u-}.  The modal stem appends a \Q{-u} to the indicative
stem. 
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c -c -c -c}
      \toprule
      & & \multicolumn{2}{c}{\Q{sovvut} “remind, exhort”} & & \multicolumn{2}{c}{\Q{leccúm} “shrink, reduce, make small”} \\
      \SetRowStyle{\bfseries} Aspect & & Indicative stem & Modal stem & & Indicative stem & Modal stem \\
      \midrule
      Perfective   & \acs{perf} & sovvut   & sovvutu  &  & leccum   & leccumu \\
      Experiential & \acs{exp}  & sovvat   & sovvatu  &  & leccam   & leccamu \\
      Momentane    & \acs{momt} & sovvit   & sovvitu  &  & leccim   & leccimu \\
      Progressive  & \acs{prog} & jassúvto & jassúvte &  & jallúcme & jallúcme \\
      Durative     & \acs{dur}  & jassávto & jassávte &  & jallácme & jallácme \\
      Habitual     & \acs{hab}  & jassívto & jassívte &  & jallícme & jallícme \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & suvvete & esávvit   & šesivvút \\
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & muččéne & emaččí & šemaččú \\
...
The modal stem appends a \Q{-u} to the indicative stem. 

The imperfective aspects use the pattern *\Q{jaC₁eC₂C₃VːC₄u}, where V is
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      ...
      \midrule
      Perfective   & \acs{perf} & zanzun    & zanzunu \\
      Experiential & \acs{exp}  & zanzan    & zanzanu \\
      Momentane    & \acs{momt} & zanzin    & zanzinu \\
      Progressive  & \acs{prog} & jazenzúnu & jazenzúne  \\
      Durative     & \acs{dur}  & jazenzánu & jazenzáne  \\
      Habitual     & \acs{hab}  & jazenzínu & jazenzíne  \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & zunzene & ezánzin  & šezinzún \\
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      ...
      \midrule
      Perfective   & \acs{perf} & vassus   & vassusu  \\
      Experiential & \acs{exp}  & vassas   & vassasu  \\
      Momentane    & \acs{momt} & vassis   & vassisu  \\
      Progressive  & \acs{prog} & javsússa & javsússe \\
      Durative     & \acs{dur}  & javsássa & javsásse \\
      Habitual     & \acs{hab}  & javsíssa & javsísse \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & vusse & evássis   & ševissús \\
...
\begin{table}[h!]\small\capstart
  ...
  \begin{tabular}{BFl -c -c -c}
    ...
    \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
    \midrule
    Stem \SetRowStyle{\itshape} & junnese  & ejánnis    & šejinnus \\
    Meaning                     & plunder & plundering & plundered \\
    \midrule
    Stem \SetRowStyle{\itshape} & vullei  & evállí     & ševillúj \\
    Meaning                     & soar    & soaring    & soared \\
    \midrule
    Stem \SetRowStyle{\itshape} & žurré   & ežárrí     & šežirrú \\
...
Roots in this pattern include \Q{sukopsu} “feed”, \Q{suroktu} “dictate”,
\Q{sudostu} “teach”, and \Q{supesku} “fell sth (e.g. a tree)”.

The basic form of Pattern III verbs is prefixing \Q{su-} onto the root
...
The perfective indicative uses a stem of the form *\Q{suC₁VC₂C₃u}. The
experiential and momentane aspects replace the final \Q{-u} with \Q{-a} or
\Q{-i}.  Pattern III verbs lack distinct modal stems in the perfective aspects.  

The imperfective aspects (progressive, durative and  habitual) use the stem
*\Q{jasuC₁C₂V₂ːC₃V₁}, where V₁ is the inherent vowel and V₂ is \Q{-ú-} for the
progressive aspect, \Q{-á-} for the durative, and \Q{-í-} for the habitual.
The modal stem replaces the final vowel with \Q{-e}. 

The infinitive is formed with the pattern *\Q{suC₁C₂uC₃e}; the active participle
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c -c -c -c}
      \toprule
      & & \multicolumn{2}{c}{\Q{sukospu} “feed”} && \multicolumn{2}{c}{\Q{sudostu} “teach”} \\
      \SetRowStyle{\bfseries} Aspect & & Indicative & Modal & & Indicative & Modal \\
      \midrule
      Perfective   & \acs{perf} & sukospu   & sukospu   &  & sudostu   & sudostu \\
      Experiential & \acs{exp}  & sukospa   & sukospa   &  & sudosta   & sudosta \\
      Momentane    & \acs{momt} & sukospi   & sukospi   &  & sudosti   & sudosti \\
      Progressive  & \acs{prog} & jasuksúpo & jasuksúpe &  & jasudsúto & jasudsúte \\
      Durative     & \acs{dur}  & jasuksápo & jasuksápe &  & jasudsáto & jasudsáte \\
      Habitual     & \acs{hab}  & jasuksípo & jasuksípe &  & jasudsíto & jasudsíte \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & suksupe & eskásip & šesuksúp \\
...
addition of the prefix \Q{su-} or the infix \Q{-s-} that is inserted immediately before
C₁.  The infix assimilates to the point of articulation of a following
fricative, effectively causing it to geminate. 

The infinitive is marked by the pattern *\Q{suC₁VːC₂e}, the active participle by the
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c}
      ...
      \midrule
      Perfective   & \acs{perf} & sutéku  \\
      Experiential & \acs{exp}  & sutéka  \\
      Momentane    & \acs{momt} & sutéki  \\
  ...
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & sutéke & estáki  & šesték \\
      Meaning                     & send   & sending & sent \\
      \bottomrule
    \end{tabular}
  }
...
\Q{su-} or the infix \Q{-s-} is inserted immediately before C₁, the infix
assimilating to a geminate C₁ if that consonant is a fricative. 

The infinitive is marked by the pattern *\Q{suC₁C₂uC₃eC₄}, the active participle
...
*\Q{suC₁V₁C₂C₂V₂}, where V₁ is the inherent vowel and V₂ is one of \Q{-u-},
\Q{-a-} or \Q{-i-}.  

The imperfective aspects use the pattern *\Q{jasC₁V₂ːC₂C₂V₂} in the infinitive,
replacing the final vowel with \Q{-e} to form the modal stem. 

The infinitive is formed with the pattern *\Q{suC₁uC₂C₂e}, the active participle
with *\Q{esuC₁aC₂C₂i}, and the participle with *\Q{šesC₁iC₂úC₂}.  
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      \toprule
      & & \multicolumn{2}{c}{\Q{suvasús} “melt”} \\
      \SetRowStyle{\bfseries} Aspect & & Indicative & Modal \\
      \midrule
      Perfective   & \acs{perf} & suvassu  & suvassu  \\
      Experiential & \acs{exp}  & suvassa  & suvassa  \\
      Momentane    & \acs{momt} & suvassi  & suvassi  \\
      Progressive  & \acs{prog} & javvússa & javvússe \\
      Durative     & \acs{dur}  & javvássa & javvásse \\
      Habitual     & \acs{hab}  & javvíssa & javvísse \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & suvusse & esuvassi & ševvisús \\
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & narukete & enrákit & šenriktu \\
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & namáre     & enmári        & šenmára \\
...
Germinate roots form Pattern IV similarly to Pattern III, except for the
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c -c -c -c}
      \toprule
      & & \multicolumn{2}{c}{\Q{ratoktu} “correspond (with)”} && \multicolumn{2}{c}{\Q{šatoptu} “buy (from)”} \\
      \SetRowStyle{\bfseries} Aspect & & Indicative & Modal & & Indicative & Modal \\
      \midrule
      Perfective   & \acs{perf} & ratoktu   & ratoktu   &  & šatoptu   & šatoptu   \\
      Experiential & \acs{exp}  & ratokta   & ratokta   &  & šatopta   & šatopta   \\
      Momentane    & \acs{momt} & ratokti   & ratokti   &  & šatopti   & šatopti   \\
      Progressive  & \acs{prog} & jaratúkta & jaratúkte &  & jašatúpta & jašatúpte  \\
      Durative     & \acs{dur}  & jaratákta & jaratákte &  & jašatápta & jašatápte  \\
      Habitual     & \acs{hab}  & jaratíkta & jaratíkte &  & jašatípta & jašatípte  \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & ratukete    & erátkit       & šeratiktu \\
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & katére        & ektári & šekatéra \\
...
Germinate roots form Pattern V similarly to Pattern III.   The perfective apects are formed with the pattern
...
The imperfective aspects are formed with the pattern *\Q{jastaC₁V₂ːC₂C₃a}, where
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      ...
      Progressive  & \acs{prog} & jastadústa & jastadúste \\
      Durative     & \acs{dur}  & jastadásta & jastadáste \\
      Habitual     & \acs{hab}  & jastadísta & jastadíste \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & istudsete & estádsit & šestidsut \\
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & istamáre & estámir    & šestimur \\
...
% by the pattern \Q{anC₁VːC₂C₃iC₄}, and the passive participle by the pattern
% \Q{šenC₁iC₂C₃úC₄}.  
...
aspects are formed with the pattern *\Q{istV₁C₁C₂V₂C₂}, where V₁ is the short
inherent vowel and V₂ is one of \Q{-u-}, \Q{-a-} or \Q{-i-}.  The imperfective
stems use the pattern *\Q{jastV₂ːC₁C₂V₁C₂}, again with V₁ as the short inherent
vowel and V₂ one of \Q{-ú-}, \Q{-á-} or \Q{-í-}.  Both aspects form the modal
stem by suffixing with \Q{-e}. 
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      ...
      \SetRowStyle{\bfseries} Aspect & & Indicative & Modal \\
      \midrule
      Perfective   & \acs{perf} & istavsus  & istavsus  \\
      Experiential & \acs{exp}  & istavsas  & istavsas  \\
      Momentane    & \acs{momt} & istavsis  & istavsis  \\
      Progressive  & \acs{prog} & jastúvsas & jastúvsas  \\
      Durative     & \acs{dur}  & jastávsas & jastávsas  \\
      Habitual     & \acs{hab}  & jastívsas & jastívsas  \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c -c}
      ...
      \SetRowStyle{\bfseries} & Infinitive & Active Participle & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & istavusse        & estávsis            & šestivsus \\
...
Pattern VII is the \emph{passive reflexive} stem, and commonly used to form anticausative verbs. 
%
%%   Pattern V roots include: 
%%   - intuCCaC
%%   - inturkat “subscribe”
%
\section{Pattern VIII: Stative}
\label{sec:vm_pattern_viii}
...
The imperfective aspects are formed with the pattern *\Q{jiC₁V₂ːC₂C₃a}, where
V₂ is \Q{-ú-} for the progressive aspect, \Q{-á-} for the durative aspect, and
\Q{-í-} for the habitual aspect.  The modal conjugations are formed by
replacing the final \Q{-a} of the indicative stems with \Q{-e}. 
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c}
      ...
      Progressive  & \acs{prog} & jikústa & jikúste \\
      Durative     & \acs{dur}  & jikásta & jikáste \\
      Habitual     & \acs{hab}  & jikísta & jikíste \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c}
      ...
      \midrule
      Stem \SetRowStyle{\itshape} & iksete     & šeiksut \\
...
The imperfective aspects are formed with the pattern *\Q{jiC₁V₂ːC₂V₁}, where V₁
...
%       Progressive  & \acs{prog} & jipúrša & jipúrše & jikústa & jikúste \\
%       Durative     & \acs{dur}  & jipárša & jipárše & jikásta & jikáste \\
%       Habitual     & \acs{hab}  & jipírša & jipírše & jikísta & jikíste \\
%       \bottomrule
%     \end{tabular}
%   }\\
%   \subfloat[Non-finite stems]{%
...
The imperfective aspects are formed with the pattern *\Q{jiC₁V₂ːC₂C₂V₁}, where
...
participle with the pattern *\Q{šiC₁C₂uC₂}.  
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c }
      ...
      Progressive  & \acs{prog} & jizúlla & jizúlle \\
      Durative     & \acs{dur}  & jizálla & jizálle \\
      Habitual     & \acs{hab}  & jizílla & jizílle \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c}
      ...
      \SetRowStyle{\bfseries}     & Infinitive & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & izelle & šizlul \\
      Meaning                     & green  & green \\
      \bottomrule
    \end{tabular}
  }
...
\begin{table}[h!]\small\capstart
  ...
  \subfloat[Aspectual stems]{%
    \begin{tabular}{BFl Sl -c -c }
      ...
      Progressive  & \acs{prog} & jihúvra & jihúvre \\
      Durative     & \acs{dur}  & jihávra & jihávre \\
      Habitual     & \acs{hab}  & jihívra & jihívre \\
      \bottomrule
    \end{tabular}
  }\\
  \subfloat[Non-finite stems]{%
    \begin{tabular}{BFl -c -c}
      ...
      \SetRowStyle{\bfseries}     & Infinitive & Passive Participle \\
      \midrule
      Stem \SetRowStyle{\itshape} & ívere     & šévur \\
      Meaning                     & good      & good \\
      \bottomrule
    \end{tabular}
  }
...
\begin{table}[h!]\small\capstart
  \begin{tabular}{SFl -l -l -l -l -l -l}
    \toprule
    \SetRowStyle{\bfseries} & \multicolumn{2}{-c}{Agent Trigger} & \multicolumn{2}{-c}{Patient Trigger}& \multicolumn{2}{-c}{Oblique Trigger} \\I'm pretty sure
