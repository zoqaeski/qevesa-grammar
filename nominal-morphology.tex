...
\begin{document}
  ...
  Like the definite state, it also has two forms, \qevesa{më} and \qevesa{mën}.   
...
%% the railway = a zeléskölij
%% some railway(s) = më zeléskölij
%% no railway(s) = nak zeléskölij

%% a house = panem
%% the house = a panem
%% some house(s) = më panem
%% no house(s) = nak panem
