...
\begin{document}
  ...
  \begin{table}[htpb]\small\capstart
      \begin{tabular}{|>{\bfseries}fc>{\scshape}c|-c-c|-c-c|}
        ...
        \hline
        \multirow{2}{*}{Focal} & \acs{foc}  & -a    & -∅   & -ina  & -na  \tabularnewline
        & \acs{foc}\sub2  & -a    & -a   & -an   & -n \tabularnewline
  ...
  \begin{table}[htpb]\small\capstart
    \begin{tabular}{|>{\bfseries}fc>{\scshape}c|-c|-c|-c|}
      ...
      Definite  & \acs{def}   & aC\sub1-  & a  & an  \tabularnewline
      Partitive & \acs{part}  & měC\sub2- & mě & měr \tabularnewline
      Negative  & \acs{neg}   & zuC\sub1- & zu & zum \tabularnewline
  ...
  \begin{table}[htpb]\small\capstart
      \subfloat{
        \begin{tabular}{|>{\scshape}fc|->{\itshape}c|-c|-c|-c|-c|-c|}
          ...
          \cline{3-7}
          \multicolumn{2}{|fc|}{\SetRowStyle{\scshape}} & \acs{ess} & \acs{ins} & \acs{ine} & \acs{ade} & \acs{ill} \tabularnewline
          \cline{3-7}
          \multicolumn{2}{|fc|}{\SetRowStyle{\itshape}} & ěl- & ětt(i)- & ěss(i)- & ěd(i)- & ěsto- \tabularnewline
          \hline
          \acs{1p}\acs{sg}           & -i/-je & ěli   & ětti    & ěssi   & ědi    & ěstí \tabularnewline
          \acs{2p}\acs{sg}           & -ta    & ělta  & ěttita  & ěssta  & ědita  & ěstota \tabularnewline
          \acs{3p}\acs{sg}           & -mi    & ělmi  & ěttimi  & ěssmi  & ědmi   & ěstomi \tabularnewline
          \acs{1p}\acs{du};\acs{inc} & -jév   & ěljév & ěttjév  & ěssjév & ědjév  & ěstojév \tabularnewline
          \acs{1p}\acs{du};\acs{exc} & -čév   & ělčév & ěttčév  & ěssčév & ědčév  & ěstočév \tabularnewline
          \acs{2p}\acs{du}           & -táv   & ěltáv & ěttitáv & ěsstáv & ěditáv & ěstotáv \tabularnewline
          \acs{3p}\acs{du}           & -mív   & ělmív & ěttimív & ěssmív & ědmív  & ěstomív \tabularnewline
          \acs{1p}\acs{pl};\acs{inc} & -jés   & ěljés & ěttjés  & ěssjés & ědjés  & ěstojés \tabularnewline
          \acs{1p}\acs{pl};\acs{exc} & -čés   & ělčés & ěttčés  & ěssčés & ědčés  & ěstočés \tabularnewline
          \acs{2p}\acs{pl}           & -tás   & ěltás & ěttitás & ěsstás & ěditás & ěstotás \tabularnewline
          \acs{3p}\acs{pl}           & -mís   & ělmís & ěttimís & ěssmís & ědmís  & ěstomís \tabularnewline
          %\hline
          \acs{inanim};\acs{sg}     & -net   & olnet & ontinet & ossnet & odnet  & ostanet \tabularnewline
          \acs{inanim};\acs{du}     & -nev   & olnev & ontinev & ossnev & odnev  & ostanev \tabularnewline
          \acs{inanim};\acs{pl}     & -nes   & olnes & ontines & ossnes & odnes  & ostanes \tabularnewline
          \hline
        \end{tabular}}\\
      \subfloat{
        \begin{tabular}{|>{\scshape}fc|->{\itshape}c|-c|-c|-c|-c|}
          ...
          \cline{3-6}
          \multicolumn{2}{|fc|}{\SetRowStyle{\scshape}} & \acs{all} & \acs{ela} & \acs{abl} & \acs{comp} \tabularnewline
          \cline{3-6}
...
%   			\hline
%   			\acs{1p}\acs{sg}       & mekai   \tabularnewline
%   			\acs{2p}\acs{sg}       & mekata  \tabularnewline
%   			\acs{3p}\acs{sg}       & mekami  \tabularnewline
%   			\acs{1p}\acs{du};inc   & mekajév \tabularnewline
%   			\acs{1p}\acs{du};exc   & mekačév \tabularnewline
%   			\acs{2p}\acs{du}       & mekatáv \tabularnewline
%   			\acs{3p}\acs{du}       & mekamív \tabularnewline
%   			\acs{1p}\acs{pl};inc   & mekajés \tabularnewline
%   			\acs{1p}\acs{pl};exc   & mekačés \tabularnewline
%   			\acs{2p}\acs{pl}       & mekatás \tabularnewline
%   			\acs{3p}\acs{pl}       & mekamís \tabularnewline
  ...
  \begin{table}[htpb]\small\capstart
      %\subfloat[Demonstrative pronouns]{
        \begin{tabular}{|>{\bfseries}fc->{\scshape}c|->{\itshape}c|-c|-c|-c|-c|}
          ...
          %\cline{3-6}
          \multicolumn{3}{|fc|}{\SetRowStyle{\scshape}} & \acs{prox} & \acs{med} & \acs{dist} & \acs{int} \tabularnewline
          \cline{4-7}
