...
\begin{document}
  ...
  It is formed by the prefix \qevesa{měC\sub2-}, that is, prefixing \qevesa{mě-} and duplicating the second root consonant. %or the clitic \qevesa{mě(n)}.
  ...
  \begin{table}[htpb]\small\capstart
    \begin{tabular}{|>{\bfseries}fc>{\scshape}c|-c|-c|}
      ...
      Partitive & \acs{part}  & měC\sub2- \tnl
...
%% some railway(s) = mělzeléskölij
%% no railway(s) = nakzeléskölij

%% a house = panem
%% the house = appanem
%% some house(s) = měnpanem
%% no house(s) = nakpanem
  ...
  \begin{table}[htpb]\small\capstart
      \subfloat{
        \begin{tabular}{|>{\scshape}fc|->{\itshape}c|-c|-c|-c|-c|-c|}
          ...
          \cline{3-7}
          \multicolumn{2}{|fc|}{\SetRowStyle{\itshape}} & ěl- & ětt- & ěss- & ěd- & ěst- \tnl
          \hline
          \acs{1p}\acs{sg}           & -(a)j   & ělaj   & ěttaj   & ěssaj   & ědaj   & ěstaj \tnl
          \acs{2p}\acs{sg}           & -ut/-ːt & ělut   & ěttut   & ěssut   & ědut   & ěstut \tnl
          \acs{3p}\acs{sg}           & -im     & ělim   & ěttim   & ěssim   & ědim   & ěstim \tnl
          \acs{1p}\acs{du};\acs{inc} & -(e)va  & ěleva  & ětteva  & ěsseva  & ědeva  & ěstěva \tnl
          \acs{1p}\acs{du};\acs{exc} & -(e)več & ěleveč & ětteveč & ěsseveč & ědeveč & ěsteveč \tnl
          \acs{2p}\acs{du}           & -(a)vut & ělavut & ěttavut & ěssavut & ědavut & ěstavut \tnl
          \acs{3p}\acs{du}           & -(a)vim & ělavim & ěttavim & ěssavim & ědavim & ěstavim \tnl
          \acs{1p}\acs{pl};\acs{inc} & -(e)sa  & ělesa  & ěttesa  & ěssesa  & ědesa  & ěstesa \tnl
          \acs{1p}\acs{pl};\acs{exc} & -(e)seč & ěleseč & ětteseč & ěsseseč & ědeseč & ěsteseč \tnl
          \acs{2p}\acs{pl}           & -(a)sut & ělaset & ěttasut & ěssasut & ědasut & ěstasut \tnl
          \acs{3p}\acs{pl}           & -(a)sim & ělasim & ěttasim & ěssasim & ědasim & ěstasim \tnl
          \hline
      ...
      \subfloat{
        \begin{tabular}{|>{\scshape}fc|->{\itshape}c|-c|-c|-c|-c|}
          ...
          \cline{3-6}
          \multicolumn{2}{|fc|}{\SetRowStyle{\itshape}} & ěft- & ěsp- & ěsk- & na- \tnl
          \hline
