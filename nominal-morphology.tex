...
%      \SetRowStyle{\itshape}   tolik & toliken     & tolikev      & tolikes \\
%                               ‘boy’ & ‘(a) boy’   & ‘(two) boys’ & ‘boys’ \\
%      \SetRowStyle{\itshape}    mari & marin       & mariv        & maris \\
...
%      \hline
%      \multicolumn{2}{fc}{\SetRowStyle{\bfseries}State} & Prefix \\
%      \hline
%      Absolute  & \acs{abst}  & ∅-        \\
%      Definite  & \acs{def}   & aC\sub1-  \\
%      Partitive & \acs{part}  & mëC\sub2- \\
%      Negative  & \acs{neg}   & nak-      \\
%      \hline
%    \end{tabular}
...
%% no house(s) = nák panem
  ...
  \begin{table}[htpb]\small\capstart
    \begin{tabular}{>{\scshape}Fl ->{\itshape}l -l -l -l -l -l -l -l -l -l}
      ...
      \multicolumn{2}{Fc}{\SetRowStyle{\itshape}} & el- & ed- & ess- & ez- & est- & ett- & esp- & epp- & na- \\
      \midrule
      ...
      \midrule
      \multicolumn{2}{Fc}{\SetRowStyle{\itshape}} & ola- & oda- & ossa- & oza- & osta- & otta- & ospa- & ompa- & no- \\
      \midrule
...
%  Section~\ref{ssec:dev_verb_form_v}, page~\pageref{ssec:dev_verb_form_v}} or
%  reciprocal\footnote{See  Section~\ref{ssec:dev_verb_form_iii},
...
%  rare.
   ...
   Qevesa possesses a single reflexive pronoun, \qevesa{meika} ‘self’, used to
