	...
	\begin{table}[htpb]\small\capstart
		\begin{center}
			...
			\begin{tabular}{|fc|-c|-c|}
				...
				9 & yok				& y-k-	\tabularnewline
				10\dec & méry	& m-r-	\tabularnewline
				\hline
			\end{tabular}}\qquad
		\subfloat{
			\begin{tabular}{|fc|-c|-c|}
...
%				9 & yok				& y-k-	&& 20\dec & vaudi			& v-d- \tabularnewline
%				10\dec & méry	& m-r-	&& 21\dec & vaudi-sen & ∅ \tabularnewline
%				\cline{1-3}\cline{5-7}
%			\end{tabular}
%			\caption{Cardinal numerals from 0\dec\ to 21\dec\label{tab:num_cardinals}}
%		\end{center}
%	\end{table}
	...
	%\newpage
	Numerals from 10\sup6\duo\ to 10\sup{12}\duo−1 are formed by the addition of the suffix \emph{-míl}:
	...
	\begin{table}[htpb]\small\capstart
		\begin{center}
			\subfloat{
				...
				\hline
				*\sup1⁄\sub0 & *domoya \tabularnewline
				*\sup1⁄\sub1 & *seneya \tabularnewline
				\sup1⁄\sub2 & ětiya    \tabularnewline
				\sup1⁄\sub3 & kölöya   \tabularnewline
				\sup1⁄\sub4 & qeséya   \tabularnewline
				\sup1⁄\sub5 & inűya    \tabularnewline
				\sup1⁄\sub6 & vonoya   \tabularnewline
				\sup1⁄\sub7 & ikuşuya  \tabularnewline
				\sup1⁄\sub8 & sopríya  \tabularnewline
				\sup1⁄\sub9 & yokoya   \tabularnewline
				\sup1⁄\sub{10} & mériya \tabularnewline
				\hline
			\end{tabular}}\qquad
			\subfloat{
				\begin{tabular}{|c|c|}
				...
				\multicolumn{2}{|c|}{\bfseries Fractional} \tabularnewline
				\hline
				\sup1⁄\sub{11} & türéya \tabularnewline
				\sup1⁄\sub{12} & żeleya \tabularnewline
				\sup1⁄\sub{13} & scemeya \tabularnewline
				\sup1⁄\sub{14} & zpeteya \tabularnewline
				\sup1⁄\sub{15} & żekölöya \tabularnewline
				\sup1⁄\sub{16} & ksożoya \tabularnewline
				\sup1⁄\sub{17} & pedłáya \tabularnewline
				\sup1⁄\sub{18} & pseňáya \tabularnewline
				\sup1⁄\sub{19} & sevčáya \tabularnewline
				\sup1⁄\sub{20} & vaudíya \tabularnewline
				\sup1⁄\sub{21} & vaudi-seneya \tabularnewline
				\hline
			\end{tabular}}
