...
\begin{document}
  ...
  Although the arrangement of consonants in a root is generally fixed, there are regular processes to derive subtle semantic variations on the meaning of the root, such as causatives and reflexives.  These root variants are called forms, or \qevesa{mettűses} (“constructions”), from the root \qevesa{mutus} (“build, construct”).  There are seven primary forms, numbered 1–7; these are listed in Table~\ref{tab:dev_root_forms}.
  ...
  \begin{table}[htpb]\small\capstart
    ...
    \subfloat[Repetition/Habitual/Intermittent]{
      \begin{tabular}{|>{\bfseries}fc|-c|-c|}
        ...
        \hline
        1 & 
        C\sub1{ü}C\sub2{é}C\sub3 
        \tnl
        2 & 
        C\sub1{ü}C\sub2C\sub2{é}C\sub3
        \tnl
        3 & 
        C\sub1{ü}C\sub2C\sub3{é} 
        \tnl
        4 & 
        {i}C\sub1C\sub2{ü}C\sub3{é}
        \tnl
        5 & 
        {mé}C\sub1{ü}C\sub2{é}C\sub3 
        \tnl
        6 & 
        {ta}C\sub1C\sub2{ü}C\sub3{é} 
        \tnl
        7 & 
        C\sub1{ë}C\sub2{ü}C\sub3{é} 
        \tnl
        \hline
      \end{tabular}
    }
  ...
  \begin{table}[htpb]\small\capstart
    ...
    \subfloat[Specific nominalisation]{
      \begin{tabular}{|>{\bfseries}fc|-c|-c|}
        ...
        \hline
        1 & 
        C\sub1{e}C\sub2{ű}C\sub3 
        \tnl
        2 & 
        C\sub1{e}C\sub2C\sub2{ű}C\sub3
        \tnl
        3 & 
        C\sub1{e}C\sub2C\sub3{ű} 
        \tnl
        4 & 
        {i}C\sub1C\sub2{e}C\sub3{ű}
        \tnl
        5 & 
        {me}C\sub1{e}C\sub2{ű}C\sub3 
        \tnl
        6 & 
        {ta}C\sub1C\sub2{e}C\sub3{ű} 
        \tnl
        7 & 
        C\sub1{ë}C\sub2{e}C\sub3{ű} 
        \tnl
        \hline
      \end{tabular}
    }
