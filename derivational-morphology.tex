...
\begin{document}
  ...
  % Form 7  Stative (Attributive)   1e2u3u   ě1u2u
  ...
  For all but a small number of irregular roots, this form is formed by inserting a \qevesa{-e-} into P\sub{12} for triliteral roots and prefixing biliteral roots with \qevesa{ě-}.
