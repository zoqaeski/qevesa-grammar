...
\begin{document}
  ...
  \begin{table}[htpb]\small\capstart
      \begin{tabular}{|>{\bfseries}fc|c c|c c|c c|c c|c c|c c|c c|}
        ...
        Fricative & & & f & \multirow{2}{*}{ʋ} & \textsubbridge{s} θ & \multirow{2}{*}{ð} & ʃ & & & & x\textasciitilde h & \tnl%\cline{1-4} \cline{6-6} \cline{8-17}
  ...
  Qevesa has eight fricative consonants: /f ʋ θ ð \textsubbridge{s} ʃ x/.  /ʋ/ and /ð/ are commonly realised as approximants, and /x/ may be realised as /h/. 
