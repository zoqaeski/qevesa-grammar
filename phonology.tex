...
%  \end{table}
  ...
  \begin{figure}[h]\capstart
    \begin{vowel}
      \putvowel{i/iː}{0\vowelhunit}{0\vowelvunit}{node}
      %\putvowel{i}{0.6\vowelhunit}{0.3\vowelvunit}{node}
      \putvowel{u/uː}{3\vowelhunit}{0pt}{node}
      \putvowel{e/eː}{1\vowelhunit}{1.5\vowelvunit}{node}
      \putvowel{o/oː}{4\vowelhunit}{1.5\vowelvunit}{node}
      \putvowel{a/aː}{3\vowelhunit}{3\vowelvunit}{node}
    \end{vowel}
  ...
  %The plosive consonants may be palatalised to [p\superj{} \tsb{t\superj} cç k\superj].
...
%    %\item /θ/ palatalises to [\tsb{s\superj}];
