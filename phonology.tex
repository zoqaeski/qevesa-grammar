...
%  \end{itemize*}
  ...
  \begin{itemize*}
    %\item A nasal, a plosive, or /r l j/ + /f θ s ʂ ɕ/
  ...
  \begin{description}
    ...
    \item[Háček/Caron] The \foreign{háček} or caron indicates a palatalised consonant variant. It is used with ⟨s⟩ and ⟨c⟩, producing ⟨š⟩ and ⟨č⟩.
  ...
  \begin{itemize*}
    ...
    \item Palatalisation is indicated by a following ⟨j⟩, an i-glide diphthong, or a \foreign{háček} above the vowel. /ji/ is represented with ⟨í⟩ and realised as /\superj iː/.
