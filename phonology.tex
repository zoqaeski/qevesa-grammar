...
\begin{description}
  ...
  \item[Ring] The ring accent is only used with \conlang{u} to produce
    \conlang{ů}. This is a long variant of \conlang{u} that stems from the
    former diphthong \conlang{*uo}, and is still pronounced that in the
