...
\begin{document}
	...
	% tall:							idemma				
	% taller:						idemmavyn			
	% the tallest:			lókidemmavyn  
	% the most tallest:	lúridemmavyn	
	%
	% Or alternatively:
	% I am taller:						vyn eduimmejeşo			
	% I am the tallest:				lókvyn eduimejeşo  
	% I am the most tallest:	lúrvyn eduimejeşo	
	%
	% You aren't very tall:    vyn eduimetaşoşery
