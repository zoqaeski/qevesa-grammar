...
\begin{document}
	...
	\begin{table}[htpb]\small\capstart
		\begin{center}
			\begin{tabular}{|>{\bfseries}fc->{\scshape}c|-c|-c|}
				...
				\tabularnewline
				Cessative & cess & 
				\textbf{e}C\sub1C\sub2\textbf{y}C\sub3C\sub3\textbf{a} & 
				\textbf{e}C\sub1\textbf{y}C\sub2C\sub2\textbf{a}
				\tabularnewline
				Durative & dur;pfv & 
	...
	% tall:							dammei					/ðamːei/
	% taller:						dammeivyn				/ðamːei.faːr/
	% the tallest:			lókdammeivyn    /loːk.ðamːei.faːr/
	% the most tallest:	lúrdammeivyn	/loːkul.ðamːei.faːr/
	%
	% Or alternatively:
	% I am taller:						vyn idemeijeşu				/faːɾʲi i.ðe.mei.je.ʂu/
	% I am the tallest:				lókvyn idemeijeşu    /loːk.faːɾʲi i.ðe.mei.je.ʂu/
	% I am the most tallest:	lúrvyn idemeijeşu	/loːkul.faːɾʲi i.ðe.mei.je.ʂu/
	%
	% You aren't very tall:    vyn idemeitaşoişery  /faːɾʲi i.ðe.mei.ta.ʂoi.ʂeːɾʲi/
	% You are very tall (POL): vyn ódemeitaşoimás   /faːɾʲi oːðe.mei.ta.ʂoi.maːs/
